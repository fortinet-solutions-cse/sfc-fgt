...
""" Run this before modifying RSPs
ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${SFF1_IP} "sudo ovs-ofctl del-flows br-sfc"
ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${SFF2_IP} "sudo ovs-ofctl del-flows br-sfc"
#ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${CLASSIFIER1_IP} "sudo ovs-ofctl del-flows br-sfc"
#ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${CLASSIFIER2_IP} "sudo ovs-ofctl del-flows br-sfc"
"""
