...
xterm -geometry 55x30+720+20 -bg darkblue -fg white -title "SF3 Log" -e ssh -t -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${SF3_PROXY_IP} "tail -F proxy.log" &
xterm -geometry 55x30+1070+20 -bg darkblue -fg white -title "SF4 Log" -e ssh -t -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ${SF4_PROXY_IP} "tail -F proxy.log" &
